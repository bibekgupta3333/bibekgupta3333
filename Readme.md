...
I'm a **Fullstack Software Engineer** passionate about building **scalable, cloud-native systems** in **Fintech, SaaS, and Agritech** domains. Currently pursuing my Master's in Computer Science at Florida Polytechnic University while leveraging 5+ years of professional experience in designing and implementing high-performance, event-driven architectures.

- 🔭 Currently working with: **AWS Serverless, Event-Driven Architecture, CQRS, Microservices**
- 🌱 Learning: **Machine Learning, Distributed Systems, Advanced Algorithm Design**
- 💼 Experience: **Re-architected systems processing 500K+ events and 50K+ transactions daily**
- 🎓 Graduate Teaching Assistant for Programming and Software Engineering Concepts
...
- 🎙️ **AWS Community Day Nepal Speaker**: Delivered session on AWS Serverless for 100+ attendees
- 🌱 **Huawei Seed for Future**: Led diabetes monitoring solution team among global participants from 50+ countries
- 👥 **Code for Change Nepal**: Mentored peers and coordinated tech bootcamps
- 🎓 **BCA Club President**: Organized tech events and bootcamps for 40+ students

## 📜 Certifications

- ☁️ AWS Certified Solution Architect
- 🚀 Serverless Framework Bootcamp (Udemy, 2022-2023)
- 📊 GraphQL Developer Associate (2022)
- 🎓 Software Engineering Bootcamp (Insight Workshop, 2020)
- 🤖 AI/ML Certifications: Machine Learning & Deep Learning (Coursera, 2020)
